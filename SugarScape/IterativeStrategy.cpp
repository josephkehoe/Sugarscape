 ...
 * @exception none
 */
IterativeStrategy::IterativeStrategy(World *sim)
:WriteStrategy(sim)
{
    //our work is done
}
 ...
 * @exception none
 */
bool IterativeStrategy::run(int startX, int startY, int size,Action *rule)
{
 ...
 * @exception none
 */
bool IterativeStrategy::concurrentRun(Action* rule)
{
...
/**
 ...
 @exception none
 */
int IterativeStrategy::participantCount(int startX, int startY, int dimSize)
{
    int pcount=0;
